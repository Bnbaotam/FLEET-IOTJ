...
def main():
    ...
    STRATEGY = "fedrep++" # for logging

    SERVER_SCRIPT_PATH = "src/fl_experiments" # where server script lives
    SERVER_SCRIPT = "server_FedRep++.py" # server script file name

    CLIENT_SCRIPT_PATH = "src/fl_experiments" # where client script lives
    CLIENT_SCRIPT = "client.py"  # client script file name

    SERVER_LOG_PATH = f'src/fl_experiments/logs/{MODEL}/{STRATEGY}/25_clients' # server log will be saved here
    SERVER_LOG = 'server-log-FedRep++-FlowChain-25-clients_state_v.txt' # server log file name
    ...
    # CLIENT CONFIGS
    clients = [
        ('Broad_2', 'client1-Broad_2-FedRep++-FlowChain-state_v.txt'),
        ('Market_1', 'client2-Market_1-FedRep++-FlowChain-state_v.txt'),
        ('Pine_1', 'client3-Pine_1-FedRep++-FlowChain-state_v.txt'),
        ('Pine_2', 'client4-Pine_2-FedRep++-FlowChain-state_v.txt'),
        ('Hwy27_1', 'client5-Hwy27_1-FedRep++-FlowChain-state_v.txt'),
        ('Hwy27_2', 'client6-Hwy27_2-FedRep++-FlowChain-state_v.txt'),
        ('Georgia_1', 'client7-Georgia_1-FedRep++-FlowChain-state_v.txt'),
        ('Georgia_2', 'client8-Georgia_2-FedRep++-FlowChain-state_v.txt'),
        ('Lindsay_1', 'client9-Lindsay_1-FedRep++-FlowChain-state_v.txt'),
        ('Lindsay_2', 'client10-Lindsay_2-FedRep++-FlowChain-state_v.txt'),
        ('C001', 'client11-C001-FedRep++-FlowChain-state_v.txt'),
        ('C002', 'client12-C002-FedRep++-FlowChain-state_v.txt'),
        ('C003', 'client13-C003-FedRep++-FlowChain-state_v.txt'),
        ('C004', 'client14-C004-FedRep++-FlowChain-state_v.txt'),
        ('C005', 'client15-C005-FedRep++-FlowChain-state_v.txt'),
        ('C028', 'client16-C028-FedRep++-FlowChain-state_v.txt'),
        ('C035', 'client17-C035-FedRep++-FlowChain-state_v.txt'),
        ('C041', 'client18-C041-FedRep++-FlowChain-state_v.txt'),
        ('C042', 'client19-C042-FedRep++-FlowChain-state_v.txt'),
        ('C043', 'client20-C043-FedRep++-FlowChain-state_v.txt'),
        ('C044', 'client21-C044-FedRep++-FlowChain-state_v.txt'),
        ('C045', 'client22-C045-FedRep++-FlowChain-state_v.txt'),
        ('C046', 'client23-C046-FedRep++-FlowChain-state_v.txt'),
        ('s110_camera_basler_south1_8mm', 'client24-s110_camera_basler_south1_8mm-FedRep++-FlowChain-state_v.txt'),
        ('s110_camera_basler_south2_8mm', 'client25-s110_camera_basler_south2_8mm-FedRep++-FlowChain-state_v.txt'),
    ...
    print("\nKill: pkill -f server_FedRep++ || pkill -f client")
    # Change the string accroding to the global vaiables
    print("\nMonitor: tail -f src/fl_experiments/log/FlowChain/fedrep++/25_clients/*.txt")
