...
Point --config_file at a YAML whose DATA.DATASET_NAME matches a scene in
src/data/TP/processed_data/ (e.g. config/TP/FlowChain/25_clients/Broad_2.yml).
Older ETH configs (hotel, zara1, etc.) use the legacy tran.pkl layout.
"""
