...
def main():
    ...
    parser.add_argument("--data_fraction", type=float, default=1.0, help="Fraction of training data to use")
    parser.add_argument("--mode", type=str, default="train", help="Mode: train/test/tune (default: train)")
    parser.add_argument("--server_port", type=int, required=True, help="Server port to connect to")
    parser.add_argument("--server_host", type=str, default="127.0.0.1", help="Server host to connect to")
    args = parser.parse_args()
