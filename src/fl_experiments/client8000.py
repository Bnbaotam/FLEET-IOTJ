...
def main():
    ...
    parser.add_argument("--server_address", type=str, default="127.0.0.1:8000", help="Flower server address (host:port)")
    ...
    # fl.client.start_numpy_client(server_address="flower-server.default.svc.cluster.local:8000", client=client)
