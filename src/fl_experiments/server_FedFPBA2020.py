...
def main():
    ...
    parser.add_argument("--port", type=int, default=2020, help="Server port (default: 9090)")
    parser.add_argument("--priority_fraction", type=float, default=0.2, 
                        help="Weight for priority client (default: 0.4)")
    parser.add_argument("--base_fraction", type=float, default=0.8, 
